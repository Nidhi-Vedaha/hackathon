            ...
            return (
              ...
              (u || t in i) &&
                (n =
                  n.replace(
                    c,
                    o ? e.map(p.default).join("/") : (0, p.default)(e)
                  ) || "/")
            );
          }) || (n = ""),
          { params: u, result: n }
          ...
          i(this, t),
            ...
            (this.onPopState = function (t) {
              ...
              if (e) {
                ...
                a.changeState(
                  "replaceState",
                  (0, h.formatWithValidation)({ pathname: P(u), query: c }),
                  (0, h.getURL)()
                );
              }
            }),
            ...
            (this.query = r),
            (this.asPath =
              (0, d.isDynamicRoute)(e) && __NEXT_DATA__.autoExport ? e : n),
            (this.basePath = ""),
            (this.sub = m),
            (this.clc = null),
            (this._wrapApp = f),
                          ...
                          switch ((e.prev = e.next)) {
                            ...
                            case 14:
                              if (
                                ...
                                (p = x(S(a) ? k(a) : a, this.locale)),
                                (this._inFlightRoute = a),
                                i._h || !this.onlyAHashChange(p))
                              ) {
                                e.next = 30;
                                break;
                              }
                              return (
                                (this.asPath = p),
                                t.events.emit("hashChangeStart", a, f),
                                this.changeState(r, n, a, i),
                                this.scrollToHash(p),
                                this.notify(this.components[this.route]),
                                t.events.emit("hashChangeComplete", a, f),
                                e.abrupt("return", !0)
                              );
                            case 30:
                              return (
                                (y = (0, v.parseRelativeUrl)(n)),
                                (w = (b = y).pathname),
                                (O = b.query),
                                (e.prev = 32),
                                (e.next = 35),
                            ...
                            case 38:
                              (A = e.sent), A.__rewrites, (e.next = 46);
                              break;
                            case 42:
                              return (
                                (e.prev = 42),
                            ...
                            case 46:
                              if (
                                ((y = this._resolveHref(y, j)).pathname !== w &&
                                  ((w = y.pathname),
                                  (n = (0, h.formatWithValidation)(y))),
                                (w = w
                                  ? (0, c.removePathTrailingSlash)(k(w))
                                  : w),
                                this.urlIsNew(p) || u || (r = "replaceState"),
                                (I = (0, c.removePathTrailingSlash)(w)),
                                (T = x(k((T = a)), this.locale)),
                                !(0, d.isDynamicRoute)(I))
                              ) {
                                e.next = 69;
                                break;
                              }
                              if (
                                ((M = (0, v.parseRelativeUrl)(T)),
                                (N = M.pathname),
                                (D = (0, g.getRouteRegex)(I)),
                                (U = (0, m.getRouteMatcher)(D)(N)),
                                (W = (q = I === N) ? R(I, N, O) : {}),
                                U && (!q || W.result))
                              ) {
                                e.next = 68;
                              ...
                              if (
                                !(
                                  (F = Object.keys(D.groups).filter(function (
                                    t
                                  ) {
                                    return !O[t];
                                  })).length > 0
                            ...
                            case 69:
                              return (
                                t.events.emit("routeChangeStart", a, f),
                                (e.prev = 70),
                                (e.next = 73),
                                this.getRouteInfo(I, w, O, a, f)
                              );
                            case 73:
                              if (
                                ((G = e.sent),
                              ...
                              if (
                                !(K = H.pageProps.__N_REDIRECT).startsWith("/")
                              ) {
                                e.next = 83;
                                break;
                              }
                              if (
                                ((Y = (0, v.parseRelativeUrl)(K)),
                                this._resolveHref(Y, j, !1),
                                !j.includes(Y.pathname))
                              ) {
                                e.next = 83;
                                break;
                              }
                              return (
                                ...
                                ($ = Q.url),
                                (J = Q.as),
                                e.abrupt("return", this.change(r, $, J, i))
                              );
                            case 83:
                              return (
                            ...
                            case 85:
                              return (
                                t.events.emit("beforeHistoryChange", a, f),
                                this.changeState(r, n, a, i),
                                (e.next = 90),
                                this.set(I, w, O, p, G).catch(function (t) {
                            ...
                            case 90:
                              ...
                              throw (
                                (t.events.emit("routeChangeError", B, p, f), B)
                              );
                            case 93:
                              return (
                                t.events.emit("routeChangeComplete", a, f),
                                e.abrupt("return", !0)
                              );
                            case 99:
                              if (
                        ...
                        for (;;)
                          switch ((e.prev = e.next)) {
                            ...
                            case 24:
                              ...
                              return (
                                (e.next = 28), this.fetchComponent("/_error")
                              );
                            case 28:
                          ...
                          switch ((t.prev = t.next)) {
                            ...
                            case 27:
                              return (
                                ...
                                t.abrupt(
                                  "return",
                                  this.handleRouteInfoError(t.t1, r, n, a, i)
                                )
                              );
                            case 30:
                            case "end":
            ...
            },
            {
              ...
              value: function (t) {
                ...
                return this.sdc[r]
                  ...
                  : I(t, this.isSsr).then(function (t) {
                      return (e.sdc[r] = t), t;
                    });
              },
            },
